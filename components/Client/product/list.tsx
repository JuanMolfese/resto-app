...
export default function ListProducts() {
  ...
  return (
    <div className="h-screen">
      ...
      <nav className="flex gap-1 items-center bg-slate-50 sticky top-0 justify-around md:justify-normal">
        <Link href={'/'} className="drop-shadow-md hover:drop-shadow-xl">
          <Image src="/LogoPizza3_high.png" alt="logo" width={80} height={80} className="cursor-pointer ml-4 md:ml-10" priority/>
        </Link>
